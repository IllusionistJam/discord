...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/IllusionistJam/">IllusionistJam</a><a href="https://github.com/IllusionistJam/discord">/discord-unblock</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />

**NEW**: Ускорение Telegram Desktop - https://github.com/boardmoosedock/telegram-ws-proxy
Альтернатива https://github.com/gpumeadowlarkstuff/telegram-ws-proxy  
...
> [!IMPORTANT]
> Все бинарные файлы в папке [`bin`](./bin) взяты из [zapret-win-bundle/zapret-winws](https://github.com/gpumeadowlarkstuff/telegram-desktop) и [zapret/releases](https://github.com/gpumeadowlarkstuff/telegram-desktop/releases). Вы можете это проверить с помощью хэшей/контрольных сумм. Проверяйте, что запускаете, используя сборки из интернета!
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/IllusionistJam/discord/releases)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/IllusionistJam/discord/releases) (`discord`)
...
- См. также [#251](https://github.com/IllusionistJam/discord/releases)
...
- См. также [#252](https://github.com/IllusionistJam/discord/releases)

### Не работает <img src="https://cdn-icons-png.flaticon.com/128/5968/5968804.png" height=18 /> Telegram

- Используйте программу [tg-ws-proxy](https://github.com/gpumeadowlarkstuff/telegram-ws-proxy )
...
💖 Отдельная благодарность разработчику [zapret](https://github.com/IllusionistJam/discord)
